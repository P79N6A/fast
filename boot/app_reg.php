...
define('APP_SALT', 'eWMS'); //数据加密或签名用的附加文字
...
$context -> register_tool('db', 'lib/db/Mysql.class.php', 'Mysql', 'IDB', 'set_db');
...
$context -> register_tool('util', 'lib/util/web_util.php');
$context -> register_tool('util', 'lib/util/db_util.php');
$context -> register_tool('util', 'lib/util/common_util.php');
...
$context -> register_renderer('XmlRenderer', 'lib/filter/XmlRenderer.class.php',
        create_function('$app', 'return $app["fmt"]=="xml";')); 
