<div class="order_wrap">
    ...
    <div class="roll stage">
        ...
        <div class="animate"><img class="bounceInLeft img_01" src="assets/img/roll_pic01_icon01.png" width="467" height="144"><img class="bounceInRight img_02" src="assets/img/roll_pic01_icon02.png" width="176" height="144"><img class="bounceInUp img_03" src="assets/img/roll_pic01_icon03.png" width="176" height="144"><img class="bounceInLeft img_04" src="assets/img/roll_pic01_icon04.png" width="176" height="144"><img class="bounceInRight img_05" src="assets/img/roll_pic01_icon05.png" width="176" height="144"><img class="bounceInUp img_06" src="assets/img/roll_pic01_icon06.png" width="852" height="90"><a href="?app_act=product/soonorder/show_order"><img class="img_07" src="assets/img/roll_pic01_btn.png"  width="303" height="93"></a></div>
    ...
    <div class="product_prof stage">
        ...
        <div class="profile">
            ...
            <div class="right">
            	<h2>eFAST365&nbsp; 电商快车</h2>
                <p class="text">eFAST365电商快车，专业的电商ERP，基于Saas化模式部署的互联网软件，应对跨行业，电商业务多变的特性，订购软件，在线付款，及时使用。免安装、 免维护、 免运维、 云端更新、 随时随地、按需增减账号等优势，最大提升系统服务品质，降低信息化投入成本，让客户专注核心业务</p>
                <p class="detail"><a href="?app_act=product/product/do_index">详情>></a></p>
                <p class="imme"><a href='?app_act=product/soonorder/show_order'>立即订购</a></p>
            </div>
        </div>
        <div class="bottm">翼商官网：www.yishangwangluo.com&nbsp; &nbsp; &nbsp; &nbsp; 400-680-9510&nbsp; &nbsp; &nbsp; &nbsp; 地址：上海市浦东新区峨山路77号金牛大厦北座301室（200127）</div>
    </div>
    <div id="guider">
