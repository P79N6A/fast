...
render_control('Form', 'form1', array(
	'conf'=>array(
		'fields'=>array(
            ...
            array('title' => '批发通知单号', 'type' => 'input', 'field' => 'relation_code'),
            ...
            array('title' => '分销商', 'type' => 'select', 'field' => 'distributor_code', 'data' => $response['fenxiao']),
	...
	'act_edit'=>'wbm/store_out_record/do_edit', //edit,add,view
	'act_add'=>'wbm/store_out_record/do_add',
	'data'=>$response['data'],
