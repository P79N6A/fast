...
<?php
render_control('PageHead', 'head1', array('title' => '零售日报详情',
    'links' => array(),
    'ref_table' => 'table'
));
?>
...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="row">
            <b></b>
            <input type="text" placeholder="商品/名称/编码/条形码" class="input" value="" id="goods_search"/>
    ...
    render_control('DataTable', 'table_list', array(
        ...
        'dataset' => 'kis/KisdeeDetailModel::get_sell_daily_detail',
...
<script type="text/javascript">
    var dataRecord = [
        ...
        {'title': '总运费', 'type': 'input', 'name': 'express_amount', 'value': '<?php echo $response['data']['express_amount'] ?>'}
    ];
