...
<div id="erp_version" <?php if ($response['info']['erp_system']== 1) {?> style="display:none;" <?php }?> >（版本最低要求：BSERP2V4.0.2-R[20150430] ）</div>
    ...
    <tr class="erp_params">
        ...
        <td width="700px">
            <div class="button-group" id="erp_type"></div>
        </td>
    </tr>
    <tr class="erp_params">
    ...
    <tr class="erp_params">
        ...
        <td width="700px">
            <input type="text" value="<?php echo $response['erp_params']['api_key']; ?>" class="input-normal bui-form-field" id="erp_key" name="erp_key" data-rules="{required: true}"/>
        </td>
    </tr>
    ...
    <tr class="qm_erp_params" style="display: none">
        ...
        <td width="700px">
            <input type="text" value="<?php echo $response['erp_params']['api_url']; ?>" class="input-normal bui-form-field" id="target_key" name="target_key" data-rules="{required: true}"/>
            <input type="button" value="测试" onclick="test();"/>
        </td>
    </tr>
    <tr class="qm_erp_params" style="display: none">
        ...
        <td width="700px">
            <input type="text" value="<?php echo $response['erp_params']['api_key']; ?>" class="input-normal bui-form-field" id="customer_id" name="customer_id" data-rules="{required: true}"/>
        </td>
    </tr>
...
//        },
//        children: [
//            {content: '直连', id: '0', selected: erp_type == 1 ? true : false},
//            {content: '奇门', id: '1', selected: erp_type == 0 ? true : false}
//        ],
//        render: '#erp_type'
//    });
//    g1.render();
