...
<?php
if ($request['new_clodop_print'] == 1) {
    echo "<script src='http://127.0.0.1:8000/CLodopfuncs.js?proper=1'></script>";
}
?>
...
<?php else: ?>
        ...
        function print_express() {
            ...
            this.init = function (param) {
                ...
                return this.set_lodop();
                    ...
                    this.get_data = function () {
                        $.post('?app_act=prm/goods_barcode/get_print_barcode_data&app_fmt=json', _this.param, function (result) {
                    ...
                    this.new_page = function () {
                        var url = '?app_act=sys/record_templates/print_barcode&';
            ...
            this.print_data = function (data) {
                ...
                LODOP.PRINT_INIT('打印条码' + timestamp);
                var now_print_num = 0;
                ...
                if (now_page < page_max) {
                    ...
                    parent.parent.$(".bui-dialog, .bui-message").attr("style", "display:none");
                    parent.parent.$(".bui-ext-mask").removeClass("bui-ext-mask");
                    parent.parent.BUI.Message.Alert('打印完成', 'success');
    ...
    <?php if ($request['new_clodop_print'] != 1) { ?>
