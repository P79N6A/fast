...
<div class="upload1">
    <div class="row form-actions actions-bar">
        <div class="offset3 ">
            <a class="button" style="float: left;" target="_blank" href="<?php echo get_excel_url("presell_detail.xlsx",1) ?>">模版下载</a>
...
<div class="result1" style="display: block;margin-top: 40px;">
        ...
        var uploader = new Uploader.Uploader({
            ...
            success: function (result) {
                BUI.Message.Confirm('确定要导入数据吗？', function () {
                    var url = result.url;
                    var r = '?app_act=op/presell/import_data&app_fmt=json&plan_code=<?php echo $request['plan_code'] ?>';
                    var params = {"url": url};
                    var msg = '';
