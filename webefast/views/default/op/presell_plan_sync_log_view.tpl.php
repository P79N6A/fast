<style>
    ...
    #skuSearchFormSubmit{margin-left: 20px;}
    .bui-grid-row{height: 32px;}
</style>
<div class="row">
        ...
        <div class="well" style="margin-left: 1em;">
            <form id="skuSearchForm" name="skuSearchForm" >
                <div style="margin: 10px;">
                    <input type="text" class="input" data-tip='{"text":"商品条码"}' name="barcode"/>
...
<script type="text/javascript">
    var plan_code = '<?php echo $request['plan_code'] ?>';
    var form;
    ...
    $(function () {
        ...
        BUI.use(['bui/grid', 'bui/data', 'bui/form', 'bui/tooltip'], function (Grid, Data, Form, Tooltip) {
            ...
            skuSelectorStore = new Data.Store({
                url: '?app_act=op/presell/get_sync_log&plan_code=' + plan_code,
            ...
            //渲染结果列表或刷新结果列表
            var columns = [
                {title: '店铺名称', dataIndex: 'shop_code_name', width: '20%', 'sortable': false},
                {title: '商品条码', dataIndex: 'barcode', width: '15%', 'sortable': false},
                {title: '平台SKUID', dataIndex: 'sku_id', width: '15%', 'sortable': false},
                {title: '同步数量', dataIndex: 'num', width: '10%', 'sortable': false},
                {title: '同步时间', dataIndex: 'insert_time', width: '22%', 'sortable': false},
                {title: '同步结果', dataIndex: 'result', width: '23%', 'sortable': false},
            ];
