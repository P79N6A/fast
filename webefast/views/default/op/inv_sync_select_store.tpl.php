...
<div class="row">
    <div class="pull-left" style="width: 20%;">
        <h3>仓库类别</h3>
        <div id="cateTree" style="overflow-y: auto;height: 380px;"></div>
    </div>
    <div class="pull-left" style="width: 80%">
        <div class="well">
            <form id="skuSearchForm" name="skuSearchForm" >
                <div style="margin: 10px;">
                    <input type="hidden" value="" name="store_property" id="store_property"/>
                    <label class="control-label">仓库名称：</label>
                    <input type="text" class="input" placeholder="仓库名称" name="store_name"/>
                    <input type="submit" value="查询" class="button button-primary" id="skuSearchFormSubmit"/>
                </div>
            </form>
        </div>
        <input type="hidden" id="djfield" name="djfield" >
        <div id="result_datatable" class="row">
    ...
    $(function () {
        ...
        BUI.use(['bui/tree', 'bui/data'], function (Tree, Data) {
            var store = new Data.TreeStore({
                ...
                url: '<?php echo get_app_url('base/store/get_nodes&app_fmt=json'); ?>'
            }),
        ...
        BUI.use(['bui/grid', 'bui/data', 'bui/form', 'bui/tooltip'], function (Grid, Data, Form, Tooltip) {
            ...
            skuSelectorStore = new Data.Store({
                url: '?app_act=op/inv_sync/select_action&app_fmt=json&type=store',
            ...
            //渲染结果列表或刷新结果列表
            var columns = [
                {title: '仓库代码', dataIndex: 'store_code', width: '50%', 'sortable': false},
                {title: '仓库名称', dataIndex: 'store_name', width: '50%', 'sortable': false}
            ];
