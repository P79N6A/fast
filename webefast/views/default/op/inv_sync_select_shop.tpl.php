        ...
        <div class="well" style="margin-left: 1em;">
            <form id="skuSearchForm" name="skuSearchForm" >
                <div style="margin: 10px;">
                    <input type="hidden" value="" name="sale_channel" id="sale_channel"/>
                    <label class="control-label">店铺名称：</label>
                    <input type="text" class="input" placeholder="店铺名称" name="shop_name"/>
    ...
    $(function () {
        ...
        BUI.use(['bui/tree', 'bui/data'], function (Tree, Data) {
            var store = new Data.TreeStore({
                ...
                url: '<?php echo get_app_url('base/sale_channel/get_nodes&app_fmt=json'); ?>'
            }),
        ...
        BUI.use(['bui/grid', 'bui/data', 'bui/form', 'bui/tooltip'], function (Grid, Data, Form, Tooltip) {
            ...
            skuSelectorStore = new Data.Store({
                url: '?app_act=op/inv_sync/select_action&app_fmt=json&type=shop&select_type=' + select_type,
            ...
            //渲染结果列表或刷新结果列表
            var columns = [
                {title: '销售平台', dataIndex: 'sale_channel_name', width: '50%', 'sortable': false},
                {title: '店铺名称', dataIndex: 'shop_name', width: '50%', 'sortable': false},
            ];
