...
<div class="upload1">
    <div class="row form-actions actions-bar">
        ...
        <a class="button" style="float: left;" target="_blank" href="<?php echo get_excel_url("strategy_customer.xlsx",1) ?>">模版下载</a>
...
$(document).ready(function (){
	$("#submit_import").click(function() {
        ...
        if(url == ''){
      	...
      	var r = '?app_act=op/op_gift_strategy/customer_import_action&strategy_code='+strategy_code+'&app_fmt=json';
      	var params = {"url": url};
      	var msg = '';
