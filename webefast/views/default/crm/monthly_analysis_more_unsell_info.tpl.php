...
<div class="panel">
    ...
    render_control('TabPage', 'TabPage1', array(
        'tabs' => array(
            ...
            array('title' => '商品编码维度', 'active' => false, 'id' => 'goods_code_unsell'),
        ),
    ...
    <div id="TabPage1Contents">
        <div>
            ...
            render_control('DataTable', 'table_list', array(
                'conf' => array(
                    'list' => array(
                        ...
                        array(
                            'type' => 'text',
                            'show' => 1,
                            'title' => '当前库存数<img height="23" width="23" data-align="top-right" class="tip" src="assets/images/tip.png" title="此报表抓取指定月份没有任何销售数据的已上架商品，按当前库存数倒序排列"',
                            'field' => 'inv_num',
                            'width' => '150',
                            'align' => ''
                        ),
                ...
                'dataset' => 'oms/SellRecordModel::barcode_unsalable_by_page',
                'export' => array('id' => 'exprot_detail', 'conf' => 'unsell_info_barcode', 'name' => '月度滞销商品（条码）','export_type'=>'file'),
                'queryBy' => 'searchForm',
                'params'=>array('filter'=>array('year_month'=>$request['year_month'],'shop_code'=>$request['shop_code']))
        ...
        <div>
            ...
            render_control('DataTable', 'table_goods', array(
                ...
                'dataset' => 'oms/SellRecordModel::goods_unsalable_by_page',
                'export' => array('id' => 'exprot_list', 'conf' => 'unsell_info_goods', 'name' => '月度滞销商品（商品）','export_type' => 'file'),
                'queryBy' => 'searchForm',
                'params'=>array('filter'=>array('year_month'=>$request['year_month'],'shop_code'=>$request['shop_code']))
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#goods_code_unsell').click(function(){
