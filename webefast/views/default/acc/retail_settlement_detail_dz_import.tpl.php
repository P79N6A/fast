<div class="upload1">
    ...
    <div class="row form-actions actions-bar">
		...
		<a class="button" target="_blank" href="<?php echo get_excel_url("retail_settlement_detail_dz.xlsx",1) ?>">模版下载</a>
		</div>
   </div>
</div>
...
<script type="text/javascript">
    BUI.use('bui/uploader',function (Uploader) {
        ...
        var uploader = new Uploader.Uploader({
            'type':'iframe',
            render: '#J_Uploader',
            url: '?app_act=acc/retail_settlement_detail/import_upload',
            //可以直接在这里直接设置成功的回调
    ...
    $(document).ready(function(){
    	...
    	$("#submit").click(function(){
            ...
            "url": url,
	   		 ...
	   		 $.post("?app_act=acc/retail_settlement_detail/import_action", result, function(data){
	             $(".upload1").hide()
	             $(".result1").show()
