...
<div><font color="red">说明：请选择需要替换现有规格的数据，并设置数量</font></div>
<script type="text/javascript">
var sell_record_detail_id = '<?php echo $response['sell_record_detail_id'] ?>';
var sell_change_detail_id = '<?php echo $response['sell_change_detail_id'] ?>';
...
<script type="text/javascript">
	...
	function ES_getSelection() {
		...
		var data = {
		         ...
		         'sell_change_detail_id':sell_change_detail_id,
		         'deal_code':deal_code,
		         'avg_money':avg_money,
		         'is_gift':is_gift
		     };
