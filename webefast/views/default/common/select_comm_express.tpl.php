        ...
        <div class="well" style="margin-left: 1em;">
            <form id="skuSearchForm" name="skuSearchForm" >
                <div style="margin: 10px;">
                    <input type="text" class="input" placeholder="快递名称/代码" name="express"/>
...
<script type="text/javascript">
    ...
    var save_up;
    var page_size = 10;
    var data_type = "<?php echo $request['data_type']; ?>";
    var params = {data_type: data_type};
    if (data_type == 'ploy_express') {
        params.ploy_code = "<?php echo $request['ploy_code']; ?>";
    }
    $(function () {
        ...
        BUI.use(['bui/grid', 'bui/data', 'bui/form', 'bui/tooltip'], function (Grid, Data, Form, Tooltip) {
            ...
            skuSelectorStore = new Data.Store({
                url: '?app_act=common/select_comm/express_data',
                params: params,
            ...
            //渲染结果列表或刷新结果列表
            var columns = [
                {title: '快递代码', dataIndex: 'express_code', width: '50%', 'sortable': false},
                {title: '快递名称', dataIndex: 'express_name', width: '50%', 'sortable': false}
            ];
