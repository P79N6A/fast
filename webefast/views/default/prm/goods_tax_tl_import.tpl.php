<div class="upload1">
    ...
    <div><input type="hidden" id="action_type" name="action_type" value="<?php echo $response['action_type']?>"></div>
    <div class="row form-actions actions-bar">
        <div class="span13 offset3 ">
            <button id="submit" class="button button-primary" type="submit">提交</button>
            <a class="button" target="_blank" href="<?php if($response['action_type'] == 'do_barcode'){echo get_excel_url("goods_tax_by_barcode.xlsx",1);}else{echo get_excel_url("goods_tax_by_goods_code.xlsx",1);} ?>">模版下载</a>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#submit").click(function () {
            ...
            $.post("?app_act=prm/goods_tax_tl/import_action", result, function (data) {
