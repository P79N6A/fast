<div class="upload1">
    ...
    <div class="row form-actions actions-bar">
        <div class="span13 offset3 ">
            ...
            <a class="button" target="_blank" href="<?php echo get_excel_url("goods_unique_code.csv",1) ?>">模版下载</a>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    BUI.use('bui/uploader', function (Uploader) {
        ...
        var uploader = new Uploader.Uploader({
            'type': 'iframe',
            render: '#J_Uploader',
            url: '?app_act=prm/goods_unique_code/import_upload',
            //可以直接在这里直接设置成功的回调
    ...
    $(document).ready(function () {
        $("#submit").click(function () {
            ...
            $.post("?app_act=prm/goods_unique_code/import_action", result, function (data) {
