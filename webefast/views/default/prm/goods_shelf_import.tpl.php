...
<div class="upload1">
    ...
    <div class="row form-actions actions-bar">
        <div class="offset3 ">
            <?php
            $csv_file = ($response['lof_status'] == 0) ? 'goods_shelf_record.xlsx' : 'goods_shelf_record_lof.xlsx';
            ?>
...
//         }).render();
    ...
    $(document).ready(function () {
        ...
        $("#submit_import_goods").click(function () {
            ...
            var r = '?app_act=prm/goods_shelf/import_action&bischecked=' + bischecked + '&app_fmt=json';
            var params = {"url": url};
            var msg = '';
