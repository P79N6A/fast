                ...
                <table class="table table-condensed" style="width: 80%;">
                    ...
                    <td style=" width: 20%" >
                        <select  id="keyword_type" name="keyword_type" class="field" style=" width: 100%">
                            <option value="goods_code" >套餐编码</option>
                            <option value="goods_name" >套餐名称</option>
                            <option value="barcode" >套餐条形码</option>
                        </select>
                    </td>
                    <td>
    ...
    $(function () {
        ...
        BUI.use(['bui/grid', 'bui/data', 'bui/form', 'bui/tooltip'], function (Grid, Data, Form, Tooltip) {
            ...
            skuSelectorStore = new Data.Store({
                url : '?app_act=prm/goods/goods_combo_select_action',
            ...
            var columns = [
                {title: '套餐编码', dataIndex: 'goods_code', width: 150, 'sortable':false},
                {title: '套餐名称', dataIndex: 'goods_name', width: 150, 'sortable':false},
                ...
                {title: '套餐条形码', dataIndex: 'barcode', width: 150, 'sortable':false},
                {title: '套餐描述', dataIndex: 'goods_desc', width: 120, 'sortable':false},
