<?php
render_control('PageHead', 'head1', array('title' => '分销结算单',
//    'links' => array(
...
render_control('DataTable', 'table', array(
    ...
    'dataset' => 'fx/AccountSettlementModel::get_by_page',
    'queryBy' => 'searchForm',
    'idField' => 'settlement_id',
    'export' => array('id' => 'exprot_list', 'conf' => 'account_settlement_do_list', 'name' => '分销商结算','export_type' => 'file'),
));
?>
