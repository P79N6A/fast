...
<div class="ordernode">
    ...
    <ul class="adaptive date">
        <?php 
        foreach($response['data']['status_info'] as $val):?>
...
$(function(){
	function show_status_info(i){ 
        ...
        var is_invalid = $.parseJSON('<?php $response['data']['is_invalid'] = isset($response['data']['is_invalid']) ? $response['data']['is_invalid'] : ''; echo json_encode($response['data']['is_invalid']);?>');
