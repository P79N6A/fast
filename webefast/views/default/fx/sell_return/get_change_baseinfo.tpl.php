...
render_control('FormTable', 'change_baseinfo_form', array(
    'conf' => array(
        'fields' => array(
            array('title' => '换货单号', 'type' => 'html', 'field' => 'change_record', 'html' => "<a href=\"javascript:openPage('订单详情','?app_act=fx/sell_record/view&sell_record_code={$response['data']['change_baseinfo']['change_record']}','订单详情')\">{$response['data']['change_baseinfo']['change_record']}</a>"),
...
//            array('title'=>'省', 'type'=>'select', 'field'=>'province','data'=>array()),
//	    array('title'=>'市', 'type'=>'select', 'field'=>'city','data'=>array()),
//	    array('title'=>'区', 'type'=>'select', 'field'=>'district','data'=>array()),
