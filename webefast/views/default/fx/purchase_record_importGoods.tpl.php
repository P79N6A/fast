...
<div class="upload1">
    <div class="row form-actions actions-bar">
        <div class="offset3 ">
            ...
            <?php } else { ?>
                <a class="button" style="float: left;" target="_blank" href="<?php echo get_excel_url("fx_purchaser_record_goods.xlsx",1) ?>">模版下载</a>
            <?php } ?>	
    ...
    BUI.use('bui/uploader', function (Uploader) {
        ...
        var uploader = new Uploader.Uploader({
            ...
            success: function (result) {
                if (confirm('确定要导入数据吗')) {
                    var url = result.url;
                    var r = '?app_act=fx/purchase_record/import_goods&app_fmt=json&is_lof=<?php echo $response['lof_status'] ?>&id=' + id;
                    var params = {"url": url};
                    var msg = '';
