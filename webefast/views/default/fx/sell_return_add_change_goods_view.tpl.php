...
$(function () {
    ...
    BUI.use(['bui/grid', 'bui/data', 'bui/form','bui/tooltip'], function (Grid, Data, Form,Tooltip) {
        ...
        url : '?app_act=fx/sell_return/select_change_goods',
...
function save_change_goods(){
	...
	var url = "?app_fmt=json&app_act=fx/sell_return/do_add_change_goods&sell_return_code=<?php echo $request['sell_return_code'];?>&store_code=<?php echo $request['store_code'];?>";
