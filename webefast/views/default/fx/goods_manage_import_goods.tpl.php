<div class="upload1">
    ...
    <div class="row form-actions actions-bar">
        <div class="span13 offset3 ">
            ...
            <a class="button" target="_blank" href="<?php echo get_excel_url("fx_goods_manage.xlsx",1) ?>">模版下载</a>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#submit").click(function() {
            ...
            var r = '?app_act=fx/goods_manage/do_import_goods&goods_line_code=' + goods_line_code + '&app_fmt=json';
            var params = {"url": url};
            var msg = '';
