...
<div class="upload1">
    <div class="row form-actions actions-bar">
        <div class="span13 offset3 ">
            <a class="button" style="float: left;" target="_blank" href="<?php if($request['op_type'] == 1){echo get_excel_url("fx_goods_adjust_price_detail.xlsx",1);}else{echo get_excel_url("fx_goods_adjust_price_detail_good.xlsx",1);} ?>">模版下载</a>
...
<script type="text/javascript">
    ...
    var op_type = "<?php echo $request['op_type'] ? $request['op_type'] : 1;?>";
    BUI.use('bui/uploader', function (Uploader) {
        ...
        var uploader = new Uploader.Uploader({
            ...
            success: function (result) {
                if (confirm('确定要导入数据吗')) {
                    var url = result.url;
                    var r = '?app_act=fx/goods_adjust_price/import_goods_upload&app_fmt=json&id=' + id +'&op_type=' + op_type;
                    var params = {"url": url};
                    var msg = '';
