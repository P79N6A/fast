...
?>
<div class="search">
    <label class="control-label">退单修改时间</label>
    <input type="text" name="start_time" id="start_time" class="calendar" style="width:150px;height:30px;"
           value="<?php echo $time_start; ?>"/>
    ~
    <input type="text" name="end_time" id="end_time" class="calendar" style="width:150px;height:30px;"
...
<script type="text/javascript">
    ...
    function task_down() {
        ...
        if (shop_code == '') {
            ...
            var url = '?app_act=api/sys/order_refund/down_refund';
            fullMask.show();
            $.ajax({
                type: "POST",
                url: url,
                data: {
                    ...
                    'end_time': end_time,
                    'sale_channel_code': sale_channel_code
                },
                dataType: "json",
    ...
    function check_progress(task_sn) {
        var check_url = '?app_act=api/sys/order_refund/down_refund_check';
        $.ajax({
            type: "POST",
            url: check_url,
