<div class="upload1">
    ...
    <div class="row form-actions actions-bar">
        <div class="span13 offset3 ">
            ...
            <a class="button" target="_blank" href="<?php echo get_excel_url('sys_goods.xlsx',1)?>">模版下载</a>
        </div>
    </div>
</div>
<div class="result1" style="display: block">
    <div style="color:red;">一次最大只能导入1000条数据</div>
</div>
<script type="text/javascript">
    BUI.use('bui/uploader',function (Uploader) {
        ...
        var uploader = new Uploader.Uploader({
            'type':'iframe',
            render: '#J_Uploader',
            url: '?app_act=api/sys/goods/import_upload',
            //可以直接在这里直接设置成功的回调
...
//
//            }, "json")
            $.post("?app_act=api/sys/goods/import_action", result, function(data){
