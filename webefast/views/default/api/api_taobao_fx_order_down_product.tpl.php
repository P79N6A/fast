...
<script>
    var url = '<?php echo get_app_url('api/api_taobao_fx_order/get_shop_by_sale_channel'); ?>';
	...
	function down_goods() {
		...
		var shop_code = $('#shop_code').val();
                ...
                if(shop_code==''){
                  ...
                  var url = '?app_act=api/api_taobao_fx_order/down_goods';
		  fullMask.show();
                    $.ajax({
			type: "POST",
			url: url,
...
function check_progress(task_sn){
    var check_url = '?app_act=api/api_taobao_fx_order/down_goods_check';
           $.ajax({
			type: "POST",
			url: check_url,
