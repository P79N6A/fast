...
<?php
$links = array();
render_control('PageHead', 'head1', array('title' => '有货采购退单详情',
    'links' => $links,
    'ref_table' => 'table'
));
?>
        ...
        <li style="overflow: visible; height: auto;">
            ...
            <div id="panel_shipping">
                ...
                render_control('DataTable', 'table', array(
                    ...
                    'dataset' => 'api/YohoReturnModel::get_goods_by_page',
                    'params' => array('filter' => array('purchase_no' => $response['data']['purchase_no'])),
                    'idField' => 'id',
                    'CellEditing' => true,
                    'events' => array(),
                ));
...
<script type="text/javascript">
    var dataRecord = [
        ...
        {'title': '总金额', 'type': 'input', 'name': 'money', 'value': '<?php echo $response['data']['money']; ?>'},
