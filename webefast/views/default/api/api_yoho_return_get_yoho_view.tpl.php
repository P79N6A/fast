    ...
    <tr>
        ...
        <td>
            <input type="text" id="start_time" name="start_time"
                   class="input-normal calendar calendar-time bui-form-field-time bui-form-field" style="width:180px;"
    ...
    $(document).ready(function () {
        $("#ok").click(function () {
            ...
            if (!shop_code) {
                ...
                $.post("?app_act=api/api_yoho_return/get_yoho_by_api", params, function (data) {
