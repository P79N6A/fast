...
<div class="row">
    <div class="control-group span10" >
        <label class="control-label">选择同步店铺：<b style="color:red"> *</b></label>
        <div class="controls">
            <div id="shop_name">
...
<div class="upload1">
    <div class="row form-actions actions-bar">
        <div class="offset3 ">
            <a class="button" style="float: left;" target="_blank" href="<?php echo get_excel_url("jit_sales_inv_adjust.xlsx",1) ?>">模版下载</a>
...
<div class="result1" style="display: block;margin-top: 20px;">
    <font color="red"> 提示：<br>1、调整库存：即以导入模板中增减库存数量直接更新唯品会平台；<br>2、增减库存：正数即增加库存，负数即减少库存</font>
    <br />
...
<script type="text/javascript">
    BUI.use(['bui/select', 'bui/data'], function (Select, Data) {
        var store = new Data.Store({
            url: '?app_act=api/wph/sales_sku/get_wepinhuijit_shop',
            autoLoad: true
        });
        ...
        var uploader = new Uploader.Uploader({
            ...
            success: function (result) {
                ...
                BUI.Message.Confirm('确定要导入数据吗？', function () {
                    var url = result.url;
                    var r = '?app_act=api/wph/sales_sku/adjust_data';
