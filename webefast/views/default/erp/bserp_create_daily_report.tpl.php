<style>
    ...
    #shop_name,#store_name,#remark{width: 200px;}
...
<form id="form_daily" action="?app_act=erp/bserp/create_daily_report_action" method="post">
    <div class="row">
    ...
    <div class="row">
        <div class="control-group span9">
            <label class="control-label">仓库：<b style="color:red"> *</b></label>
            <div class="controls">
                <input type="hidden" value="" name="store_code"/>
                <input type="text" readonly="readonly" id="store_name" class="input-normal control-text" data-rules="{required:true}" data-messages="{required:'请选择仓库'}">
                <a href="#" id = 'select_store'><img src='assets/img/search.png'></a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="control-group span9">
            ...
            <div class="controls">
                <div id="record_type_select">
                    <input type="hidden" id="record_type" name="record_type" value="all" data-rules="{required:true}" data-messages="{required:'请选择日报类型'}"/>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="control-group span9">
            <label class="control-label">区分分销：<b style="color:red"> *</b></label>
            <div class="controls">
                <div id="is_fenxiao_select">
                    <input type="hidden" id="is_fenxiao" name="is_fenxiao" value="1" data-rules="{required:true}" data-messages="{required:'请选择是否区分分销'}"/>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="control-group span8">
            <label class="control-label" style="margin-left: -10px;margin-right: 10px">备注：</label>
            <div class="controls">
    ...
    <p style="color:red;position: fixed;bottom: 1px;">
        友情提示：按照店铺/仓库/日报类型/区分分销每天生成一张日报，每次仅能生成一天的日报。
    </p>
</form>
<script>
    $(function () {
    ...
    BUI.use('bui/select', function (Select) {
        ...
        var fenxiao_type = [
            ...
            {text: '否', value: '0'}
                ...
                fenxiao_select = new Select.Select({
                    render: '#is_fenxiao_select',
                    valueField: '#is_fenxiao',
                    items: fenxiao_type,
                    width: 130
                });
        fenxiao_select.render();
    });
    ...
    function show_select(_type) {
        ...
        var url = '?app_act=base/' + _type + '/base_selection&select_type=erp'
        var buttons = [
            {
                text: '确定',
