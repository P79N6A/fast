<?php
render_control('PageHead', 'head1', array('title' => 'BS3000J批发单据', 'ref_table' => 'table'));
...
render_control('SearchForm', 'searchForm', array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'select',
            'id' => 'store_code',
            'data' => load_model('erp/Bs3000jModel')->get_erp_store_code()
        ),
        array(
            'label' => '单据类型',
            'type' => 'select',
...
render_control('DataTable', 'table', array(
    ...
    'dataset' => 'erp/Bs3000jModel::get_wbm_by_page',
    'queryBy' => 'searchForm',
    'idField' => 'id',
    'CheckSelection' => true,
));
...
<script>
    ...
    function upload(record_codes) {
        ...
        $.post("?app_act=erp/bs3000j/wbm_upload", params, function (data) {
            if (data.status == 1) {
