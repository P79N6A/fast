...
render_control('PageHead', 'head1', array('title' => 'BSERP商品库存维护日志',
    'links' => array(
   ...
   array(
    ...
    'fields' => array (
        array(
            ...
            'type' => 'select_multi',
            'id' => 'store_code',
            'data' => load_model('sys/ShopStoreModel')->get_erp_store_code('erp')
        ),
        array (
            'label' => '商品编码',
            'type' => 'input',
...
<?php render_control ( 'DataTable', 'table', array (
    'conf' => array (
        'list' => array (
            array (
                ...
                'align' => '',
                'buttons' => array (
                    array('id'=>'get_inv_and_update', 'title' => '获取ERP库存并更新', 'callback'=>'get_inv_and_update'),
                ),
            ),
    ...
    'dataset' => 'erp/BserpInvSyncModel::get_by_page',
    'queryBy' => 'searchForm',
    'idField' => 'id',
//	'CheckSelection'=>true,
) );
...
<script type="text/javascript">
    ...
    $(".btn_upload_record").click(function(){
        ...
        get_checked($(this), function(ids){
        	//校验是否绑定批发通知单
         	 ...
         	 $.post("?app_act=erp/bserp/upload_multi", d, function(data){
    ...
    function get_inv_and_update(index, row){
        url = '?app_act=erp/bserp/get_inv_and_update';
