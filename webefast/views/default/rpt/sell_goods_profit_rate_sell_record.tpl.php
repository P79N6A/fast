...
if(!empty($response['proprety'])) {
    ...
    'dataset' => 'oms/SellGoodsProfitRateModel::sell_by_page',
  //  'queryBy' => 'searchForm',
    'init' => 'nodata',
    'customFieldTable' => 'rpt/sell_record_table',
    'idField' => 'sell_record_code',
    'export'=> array('id'=>'exprot_sell_record','conf'=>'sell_goods_profit_rate_sell_record','name'=>'销售商品毛利分析','export_type'=>'file'),
) );
?>
