...
render_control('PageHead', 'head1', array(
    'title' => isset($app['title']) ? $app['title'] : '编辑批发退货类型',
    'links' => array('base/wholesale_return_type/do_list' => '批发退货类型列表',
    )
));
?>
<?php
render_control('Form', 'record_type_form', array(
    ...
    'act_edit' => 'base/wholesale_return_type/do_edit', // edit,add,view
    'act_add' => 'base/wholesale_return_type/do_add',
    'data' => $response['data'],
    'rules'=>array(
