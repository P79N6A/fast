...
render_control('PageHead', 'head1', array(
    'title' => isset($app['title']) ? $app['title'] : '编辑批发销货类型',
    'links' => array('base/wholesale_sales_type/do_list' => '批发销货类型列表',
    )
));
?>
<?php
render_control('Form', 'record_type_form', array(
    ...
    'act_edit' => 'base/wholesale_sales_type/do_edit', // edit,add,view
    'act_add' => 'base/wholesale_sales_type/do_add',
    'data' => $response['data'],
    'rules'=>array(
