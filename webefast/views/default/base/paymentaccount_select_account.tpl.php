        ...
        <div class="well">
            <form id="skuSearchForm" name="skuSearchForm" >
                <div style="margin: 10px;">
                    ...
                    <input type="text" class="input" placeholder="收款账户" name="account_name"/>
    ...
    $(function () {
        ...
        BUI.use(['bui/grid', 'bui/data', 'bui/form', 'bui/tooltip'], function (Grid, Data, Form, Tooltip) {
            ...
            skuSelectorStore = new Data.Store({
                url: '?app_act=base/paymentaccount/select_account_data',
            ...
            //渲染结果列表或刷新结果列表
            var columns = [
                {title: '账户名称', dataIndex: 'account_name', width: 150, 'sortable': false, renderer: function (value, obj) {
                        if (value.length < 12) {
                            return value;
                        } else {
                ...
                {title: '开户银行', dataIndex: 'account_bank', width: 150, 'sortable': false},
                {title: '开户账号', dataIndex: 'bank_code', width: 100, 'sortable': false}
            ];
