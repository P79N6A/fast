...
render_control('Form', 'form1', array(
	'conf'=>array(
		'fields'=>array(
            ...
            array('title' => '供应商', 'type' => 'select', 'field' => 'supplier_code', 'data' => $response['supplier']),
		...
		'hidden_fields'=>array(array('field'=>'return_record_id')), 
	), 
	'buttons'=>array(
			array('label'=>'提交', 'type'=>'submit'),
			array('label'=>'重置', 'type'=>'reset'),
	),
	'act_edit'=>'pur/return_record/do_edit', //edit,add,view
	'act_add'=>'pur/return_record/do_add',
	'data'=>$response['data'],
