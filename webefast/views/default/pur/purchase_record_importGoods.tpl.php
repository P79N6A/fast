    ...
    <div class="row form-actions actions-bar">
        <div class="offset3 ">
            <?php if ($response['lof_status'] == 1) { ?>            
                <a class="button" style="float: left;" target="_blank" href="<?php echo get_excel_url("purchaser_record_lof.xlsx",1) ?>">模版下载</a>
            <?php } else { ?>
                <a class="button" style="float: left;" target="_blank" href="<?php echo get_excel_url("purchaser_record.xlsx",1) ?>">模版下载</a>
            <?php } ?>	
