...
<div class="upload1">
    ...
    <div class="row form-actions actions-bar">
        ...
        <?php if($response['lof_status']==1){?>            
          <a class="button" target="_blank" style="float: left;" href="<?php echo get_excel_url("return_notice_record_lof.xlsx",1) ?>">模版下载</a>
        <?php }else{ ?>
          <a class="button" target="_blank" style="float: left;" href="<?php echo get_excel_url("return_notice_record.xlsx",1) ?>">模版下载</a>
        <?php } ?> 
...
$(document).ready(function (){
	$("#submit_import_goods").click(function() {
        ...
        if(url == ''){
      	...
      	var r = '?app_act=pur/return_notice_record/import_goods_upload&is_lof=<?php echo $response['lof_status']?>&app_fmt=json&id='+id;
      	var params = {"url": url};
      	var msg = '';
