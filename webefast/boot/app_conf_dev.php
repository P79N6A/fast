...
//
//// database name
if (!isset($db_name)) $db_name   = "efast5_b2";
//
//// database username
 ...
 * 资源文件路径
 */
$common_http_url = '/efast_trunk/efast365/webpub/';
 ...
 * 登陆服务入口地址
 */
$login_server = 'http://localhost/efast_trunk/efast365/webefast/web/?app_act=index/login';

$global_clean_xss = true;
...
//saas 配置
$saas_client_id = 12;
$saas_product_version = 'efast5_Standard';
$saas_rds_id = 1; 
$is_strong_safe = FALSE; //是否强安全模式模式