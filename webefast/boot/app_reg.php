...
define('CLOUD',false);              //是否云版本
define('RUN_SAAS',false);              //是否开启SAAS模式
define('RUN_MODE', 'DEV'); // PRO 生产模式  TEST 测试模式  DEV 开发模式
...
//新增saas类
$context -> register_tool('saas', 'lib/tool/Saas.class.php');
/**
* *end 系统设置*
*/
...
//$context->register_request_filter('OperateLogFilter', 'lib/filter/OperateLogFilter.class.php');
$context->register_request_filter('SecurityCSRFFilter', 'lib/filter/SecurityCSRFFilter.class.php');
$context->register_request_filter('SecurityFilter', 'lib/filter/SecurityFilter.class.php');
...
if (defined('RUN_CONTROL') && RUN_CONTROL) {
	$context -> register_request_filter('ControlFilter', 'lib/ctl/Control.class.php',
    create_function('$app', 'return $app["fmt"]=="html" && $app["err_no"]==0;'));
		include_once ROOT_PATH . 'lib/ctl/Control.class.php';
}
...
// reponse filter
$context->register_response_filter('TaskFilter', 'lib/filter/TaskFilter.class.php', create_function('$app', 'return $app["mode"]=="cli" ;'));
