...
class ShunfengPurReturnNoticeModel extends WmsWbmNoticeModel {
    ...
    function convert_data($record_code) {
        ...
        $data['SfOrderType'] = "退仓订单";
        $data['ErpOrder'] = $order['record_code'];
        $data['TradeOrderDateTime'] = $order['record_time'];
        $data['OrderReceiverInfo']['ReceiverCompany'] =  $order['supplier']['supplier_name'];
        $data['OrderReceiverInfo']['ReceiverName'] = $this->html_decode($order['supplier']['contact_person']);
        $data['OrderReceiverInfo']['ReceiverZipCode'] = !empty($order['supplier']['zipcode']) ? $order['supplier']['zipcode']:"";
        $data['OrderReceiverInfo']['ReceiverMobile'] = !empty($order['supplier']['mobile']) ? $order['supplier']['mobile'] : '';
        $data['OrderReceiverInfo']['ReceiverPhone'] = $order['supplier']['tel'];
        $data['OrderReceiverInfo']['ReceiverAddress'] = $order['supplier']['address'];
