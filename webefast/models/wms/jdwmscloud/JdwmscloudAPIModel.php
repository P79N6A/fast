...
class JdwmscloudAPIModel extends WmsAPIModel {
    ...
    public function __construct($token = array()) {
        ...
        $this->api_response_conf = array(
            'jingdong.eclp.rtw.acceptReturnOrder' => 'jingdong_eclp_rtw_acceptReturnOrder_responce',
            'jingdong.eclp.rtw.queryReceipt' => 'jingdong_eclp_rtw_queryReceipt_responce',
            'jingdong.eclp.cloud.queryReceivingResult' => 'jingdong_eclp_cloud_queryReceivingResult_responce',
            'jingdong.eclp.goods.transportGoodsInfo' => 'jingdong_eclp_goods_transportGoodsInfo_responce',
            'jingdong.eclp.stock.queryStock' => 'jingdong_eclp_stock_queryStock_responce',
            'jingdong.eclp.po.addPoOrder' => 'jingdong_eclp_po_addPoOrder_responce'
        );
    }
