...
class GiftStrategyCustomerModel extends TbModel{
...
//        strategy_code
    ...
    function clear_data($strategy_code){
        return parent::delete(array('strategy_code'=>$strategy_code));
    }
    ...
    function get_customer_by_detail_id($detail_id) {
        $data = $this->get_all(array('op_gift_strategy_detail_id' => $detail_id));
        return $data;
    }
