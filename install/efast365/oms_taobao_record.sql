...
DROP TABLE IF EXISTS `oms_taobao_record`;
CREATE TABLE `oms_taobao_record` (
  ...
  `is_change` int(4) DEFAULT '0' COMMENT '0：未转单 1：转单成功 2：转入中 3：标记转单',
...
) ENGINE=InnoDB AUTO_INCREMENT=391 DEFAULT CHARSET=utf8 COMMENT='淘宝订单';
