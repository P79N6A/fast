DROP TABLE IF EXISTS `wms_b2b_trade`;
CREATE TABLE `wms_b2b_trade` (
  ...
  `wms_order_flow_end_flag` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'wms订单流转结束 取消成功 已发货/收货/关闭订单',
  ...
  `buyer_nick` varchar(10) NOT NULL DEFAULT '' COMMENT '买家昵称',
