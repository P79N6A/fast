DROP TABLE IF EXISTS `pur_return_notice_record_detail`;
CREATE TABLE `pur_return_notice_record_detail` (
...
) ENGINE=INNODB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='采购退货通知明细表';