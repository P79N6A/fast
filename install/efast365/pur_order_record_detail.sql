DROP TABLE IF EXISTS `pur_order_record_detail`;
CREATE TABLE `pur_order_record_detail` (
  `order_record_detail_id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`order_record_detail_id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COMMENT='商品采购订单明细表';