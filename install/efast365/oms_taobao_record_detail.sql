...
DROP TABLE IF EXISTS `oms_taobao_record_detail`;
CREATE TABLE `oms_taobao_record_detail` (
  `taobao_record_detail_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`taobao_record_detail_id`)
) ENGINE=InnoDB AUTO_INCREMENT=497 DEFAULT CHARSET=utf8 COMMENT='淘宝订单详情';
