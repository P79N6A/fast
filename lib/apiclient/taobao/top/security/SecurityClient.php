...
//	include './iCache.php';
//	include '../../TopSdk.php';
    require_lib('apiclient/taobao/top/security/SecurityUtil');
    require_lib('apiclient/taobao/top/security/SecretGetRequest');
    require_lib('apiclient/taobao/top/security/TopSdkFeedbackUploadRequest');
    require_lib('apiclient/taobao/top/security/iTCache');

    require_lib('apiclient/taobao/TopSdk');
