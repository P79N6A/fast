...
class nusoap_base {
   ...
   // var $soap_defencoding = 'ISO-8859-1';
	var $soap_defencoding = 'UTF-8';//wq edit
...
class nusoap_client extends nusoap_base  {
	...
	*/
    function parseResponse($headers, $data) {
		...
		$this->debug('Use encoding: ' . $this->xml_encoding . ' when creating nusoap_parser');
		$filepath =  '/www/webroot/efast365/logs/server2323_api_' . date('Ymd') . '.log';
        file_put_contents($filepath,  "	121323:" . var_export(debug_backtrace() , TRUE) . "\n", FILE_APPEND);
