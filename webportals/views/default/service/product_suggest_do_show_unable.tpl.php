...
<form  class="form-horizontal" id="form1" action="?app_act=servicenter/productxqissue/do_xqissueunable" method="post">
<?php render_control('Form', 'form1', array(
	...
	'act_add'=>'servicenter/productxqissue/do_xqissueunable',
	'data'=>$response['data'], 
        'rules'=>array(
