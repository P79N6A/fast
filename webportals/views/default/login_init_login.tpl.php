...
<html>
    <head>
        ...
        <title>宝塔科技渠道门户</title>
        <style>
            .login_con{position: absolute; right: -25px; }
            #msg_show{top: 380px;}
        </style>
                ...
                <div class="login_con">
                    ...
                    <p class="lab">
                        <span class="text_bg focus">
                            <input type="text"  name="1" placeholder="用户登录名" value="<?php echo isset($_COOKIE['username']) ? $_COOKIE['username'] : ''; ?>"  id="username" />
                        </span>
                    </p>
                    <p class="lab">
                        <span class="text_bg ">
                            <input type="password" name="2" placeholder="请输入你的密码" id="password" />
                        </span>
                    </p>
                    <p id="capdiv" class="lab" style="display:none">
                        <span class="text_bg ">
                            <input name="3" type="text"  id="captcha" />
                            <img title="看不清楚，双击图片换一张" alt="验证码" src="?app_act=login/captcha&code=code" onclick="this.src = this.src + '&' + Math.round(Math.random(0) * 1000)" style="cursor:pointer;width: 58px;height: 35px; vertical-align: middle;">
                        </span>
                    </p>
                    ...
                    <p class="lab_t" id="msg_show">欢迎来到宝塔科技渠道门户</p>
                </div>
