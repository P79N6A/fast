...
$state = time();
$url = "http://www.mogujie.com/openapi/api_v1_oauth/index";

$param['response_type'] = 'code';
$param['redirect_uri'] = 'http://operate.yishangonline.com:81/session/mgj/authorize_callback.php';
$param['state'] = $state;
$param['app_key'] = $_REQUEST['app_key'];
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en_US" xml:lang="en_US">
 ...
 <body>
	...
	<div>
	<h2>蘑菇街API2.0 access_token</h2>
	<div>
		<form action="index.php">

			app_key <input type="text" name="app_key" value="" size="50"/><br />
			<input type="submit" name="" value="获取蘑菇街API2.0 access_token"/><br />
		</form>
	</div>

	<h3>
	1、输入蘑菇街后台取得的app_key <br/>
	2、输入客户蘑菇街商家后台的账号和密码 <br/>
	3、在出现的页面中点“授权” <br/>
	4、页面上面显示的“授权码”请COPY下来，这个“授权码”就是蘑菇街API2.0 access_token <br/>
	</h3>
	</div>
