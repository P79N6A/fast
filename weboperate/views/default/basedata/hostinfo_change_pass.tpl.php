...
//			array('title'=>'客户名称', 'type'=>'select','field'=>'kh_id','data'=>ds_get_select('kehu',2)),
                        array('title'=>'密码类型', 'type'=>'select', 'field'=>'pass_type','data'=>ds_get_select_by_field('passtype',2)),
                        array('title'=>'原密码', 'type'=>'password', 'field'=>'oldpass', ),
	...
	'act_edit'=>'basedata/hostinfo/change_pass',
	'data'=>$response['data'],
