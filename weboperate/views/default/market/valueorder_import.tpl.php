...
<div class="upload1">
    <div class="row form-actions actions-bar">
        <div class="span13 offset3 ">
                <a class="button" style="float: left;" target="_blank" href="<?php echo get_excel_url("valueorder_main_import.xlsx",1) ?>">模版下载</a>
...
<script type="text/javascript">
    BUI.use('bui/uploader', function (Uploader) {
         ...
         */
        var url = '?app_act=market/valueorder/import_goods&app_fmt=json';
        var filetype = {
        ...
        var uploader = new Uploader.Uploader({
            ...
            success: function (result) {
                BUI.Message.Confirm('确定要导入数据吗？',function(){
                    ...
                    var r = '?app_act=market/valueorder/do_import_action&app_fmt=json';
                    var params = {"url": url};
                    var msg = '';
            ...
            error: function (result) {
                BUI.Message.Alert("失败88+8", "error")
            }
        }).render();
    });
</script>              
